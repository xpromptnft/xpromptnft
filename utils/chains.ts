...
export default [
  ...
  {
    ...polygonMumbai,
    iconUrl: `/icons/currency/polygonmumbai.webp`,
    reservoirBaseUrl: process.env.ARBITRUM_RESERVOIR_API_BASE,
    proxyApi: '/api/nftearth/arbitrum',
    routePrefix: 'polygonMumbai',
    apiKey: process.env.ARBITRUM_RESERVOIR_API_KEY,
  },
  {
    ...filecoin,
    iconUrl: `/icons/currency/Filecoin.png`,
    reservoirBaseUrl: process.env.ARBITRUM_RESERVOIR_API_BASE,
    proxyApi: '/api/nftearth/filecoin',
    routePrefix: 'polygonMumbai',
    apiKey: process.env.ARBITRUM_RESERVOIR_API_KEY,
  },
  {
    ...goerli,
    iconUrl: `/icons/currency/goerli.png`,
    reservoirBaseUrl: process.env.ARBITRUM_RESERVOIR_API_BASE,
    proxyApi: '/api/nftearth/goerli',
    routePrefix: 'polygonMumbai',
    apiKey: process.env.ARBITRUM_RESERVOIR_API_KEY,
  },
  {
    ...gnosis,
    iconUrl: `/icons/currency/gnosis.png`,
    reservoirBaseUrl: process.env.ARBITRUM_RESERVOIR_API_BASE,
    proxyApi: '/api/nftearth/goerli',
    routePrefix: 'polygonMumbai',
    apiKey: process.env.ARBITRUM_RESERVOIR_API_KEY,
